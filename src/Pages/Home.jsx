            ...
            <div className='h-full relative top-0 left-0'>
                ...
                <div className='container mx-auto md:pt-32 space-y-8'>
                    ...
                    <div className='space-x-6'>
                        <button className='px-3 py-2 rounded bg-green-500 text-lg font-normal text-white hover:bg-green-600 shadow drop-shadow-text-lg'>Hire Me</button>
                        <button className='px-3 py-2 rounded bg-green-500 text-lg font-normal text-white hover:bg-green-600 shadow drop-shadow-2xl'>Contact us</button>
                    </div>
                </div>
